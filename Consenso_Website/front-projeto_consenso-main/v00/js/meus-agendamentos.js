...
async function getServicosPorId() {
                ...
                for (let index = 0; index < data.length; index++) {
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-12 text-start fs-5">
                      <label for="nomePrestador"><strong>Prestador: </strong>${element.servico.usuario.nome}</label>
                      <label for=""></label>
                    </div>
                    ...
                    <div class="col-12 text-start fs-5">
                      <label for="hora"><strong>Horário: </strong> ${element?.hora[0]}:${element?.hora[1]}</label>
                    </div>
  ...
  function funcaoEditar(id){
    ...
    window.location.href= "../cliente/editar-agendamento.html"
  }
